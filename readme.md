...
Ambos os membros contribuiram de igual forma (50% / 50%) para este trabalho.
...
## Demonstrações
Foram incluídos estados de jogo intermédios para uma demonstração mais rápida.
Estes estados de jogo podem ser acedidos através dos seguintes comandos:
